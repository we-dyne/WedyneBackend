...
menuItem2 = MenuItem(user_id=1,
                     ...
                     description=" A famous duck dish"
                                 " from Beijing[1] that"
                                 " has been prepared since"
                                 " the imperial era. The meat"
                                 " is prized for its thin, crisp"
                                 " skin, with authentic versions"
                                 " of the dish serving mostly the"
...
menuItem6 = MenuItem(user_id=1,
                     name="Ramen",
                     description="a Japanese noodle"
                                 " soup dish. It consists"
                                 " of Chinese-style wheat noodles"
                                 " served in a meat- or (occasionally)"
                                 " fish-based broth, often flavored"
                                 " with soy sauce or miso, and uses"
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     description="a Vietnamese noodle"
                                 " soup consisting of"
                                 " broth, linguine-shaped"
                                 " rice noodles called"
                                 " banh pho, a few herbs,"
                                 " and meat.",
                     price="$8.99",
                     course="Entree",
                     picture="https://bit.ly/2y3WN9U",
...
menuItem2 = MenuItem(user_id=1,
                     ...
                     description="a common Chinese"
                                 " dumpling which generally"
                                 " consists of minced meat"
                                 " and finely chopped vegetables"
                                 " wrapped into a piece of"
                                 " dough skin. The skin can"
                                 " be either thin and elastic"
                                 " or thicker.",
                     price="$6.99",
                     course="Appetizer",
                     picture="https://bit.ly/2y3WN9U",
...
menuItem3 = MenuItem(user_id=1,
                     name="Gyoza",
                     description="light seasoning of"
                                 " Japanese gyoza with"
                                 " salt and soy sauce,"
...
menuItem4 = MenuItem(user_id=1,
                     name="Stinky Tofu",
                     description="Taiwanese dish,"
                                 " deep fried fermented"
                                 " tofu served with pickled"
                                 " cabbage.",
                     price="$6.99",
                     course="Entree",
                     picture="https://bit.ly/2y3WN9U",
...
menuItem2 = MenuItem(user_id=1,
                     ...
                     description="Portabello mushrooms"
                                 " in a creamy risotto",
                     price="$5.99",
                     course="Entree",
                     picture="https://bit.ly/2y3WN9U",
...
menuItem3 = MenuItem(user_id=1,
                     ...
                     description="Milk snow layered"
                                 " with honey boba,"
                                 " jasmine tea jelly,"
                                 " grass jelly, caramel, cream,"
...
menuItem4 = MenuItem(user_id=1,
                     ...
                     description="Golden fried cauliflower"
                                 " florets in a midly"
                                 " spiced soya,garlic"
                                 " sauce cooked with fresh"
                                 " cilantro, celery, chilies,"
                                 " ginger & green onions",
                     price="$6.95",
                     course="Appetizer",
                     picture="https://bit.ly/2y3WN9U",
...
menuItem5 = MenuItem(user_id=1,
                     ...
                     description="Vegan goodness. Burrito"
                                 " filled with rice, garbanzo"
                                 " beans, curry sauce, potatoes"
                                 " (aloo), fried cauliflower"
...
menuItem4 = MenuItem(user_id=1,
                     name="Choc Full O\' Mint"
                          " (Smitten\'s Fresh Mint Chip ice cream)",
...
menuItem5 = MenuItem(user_id=1,
                     name="Tonkatsu Ramen",
                     description="Noodles in a"
                                 " delicious pork-based"
...
menuItem1 = MenuItem(user_id=1,
                     name="Lamb Curry",
                     description="Slow cook that"
                                 " thang in a pool of"
                                 " tomatoes, onions and alllll"
...
menuItem2 = MenuItem(user_id=1,
                     name="Broiled salmon",
                     description="Salmon fillet marinated"
...
menuItem3 = MenuItem(user_id=1,
                     ...
                     description="Wild morel mushrooms"
                                 " fried in butter, served on"
                                 " herbed toast slices",
                     price="$7.50",
                     course="Appetizer",
                     picture="",
...
menuItem4 = MenuItem(user_id=1,
                     ...
                     description="Chicken marinated in"
                                 " yoghurt and seasoned with a spicy"
                                 " mix(chilli, tamarind among others) and"
                                 " slow cooked in a cylindrical clay or metal"
                                 " oven which gets its"
                                 " heat from burning charcoal.",
                     price="$8.95",
                     course="Entree",
                     picture="https://bit.ly/2Nk2Qg8",
                     restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1,
                     ...
                     description="Golden brown, corn-based Venezuelan"
                                 " pancake; usually stuffed with queso"
                                 " telita or queso de mano,"
                                 " and possibly lechon. ",
                     price="$7.99",
                     course="Entree",
                     picture="https://bit.ly/2P4b8KA",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     description="Crispy Toast with Sesame"
                                 " Seeds slathered with buttery"
                                 " chantrelle mushrooms",
                     price="$5.95",
                     course="Appetizer",
                     picture="https://bit.ly/2DUuyka",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     description="Lemon Curd Ice Cream Sandwich"
                                 " on a chocolate macaron with"
                                 " cardamom meringue and cashews",
                     price="$4.25",
                     course="Dessert",
                     picture="https://bit.ly/2P2TB5A",
                     restaurant=restaurant1)
